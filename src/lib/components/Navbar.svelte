<script lang="ts">
	...
	const linkStyle =
		'text-snow-300 text-3xl text-center pt-1 pb-1 pl-2 pr-2 box-border grid place-items-center h-12 rounded-md hover:text-snow-100 hover:bg-polar-200 active:bg-polar-100';
</script>
