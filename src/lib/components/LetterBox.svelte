...
<div
	class="grid aspect-square w-full grid-rows-3 rounded-xl text-center text-lg font-bold text-snow-300 sm:text-xl md:text-2xl lg:text-3xl"
...
>
	<label for={name} class="opacity-0">{`row ${row} col ${slot}`}</label>
	<input
		readonly
	...
	/>
	<svg
		class="relative bottom-1 row-start-3 m-auto w-2 animate-spin sm:w-4"
